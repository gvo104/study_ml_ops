...
from drift_v2.runner.pipeline import build_sample_stream, build_windows
from drift_v2.runner.prom_metrics import build_prom_metrics_latest
from drift_v2.runner.reference import ensure_reference_snapshot
from drift_v2.runner.reporting import (
    append_jsonl,
...
from drift_v2.runner.scenario import build_phase_sequence
...
@click.option(
    ...
    default="drift_v2/configs/runner.yaml",
    show_default=True,
)
@click.option(
    "--mode",
